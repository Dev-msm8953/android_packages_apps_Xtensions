...
public class SBWeather extends SettingsPreferenceFragment implements
    ...
    static final int DEFAULT_WEATHER_FONT_COLOR = 0xffffffff;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mWeatherFontColor.setOnPreferenceChangeListener(this);
            intColor = Settings.System.getInt(resolver,
                    Settings.System.STATUS_BAR_WEATHER_FONT_COLOR, DEFAULT_WEATHER_FONT_COLOR);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
 	ContentResolver resolver = getActivity().getContentResolver();
        ...
        if (preference == mWeatherFontColor) {
